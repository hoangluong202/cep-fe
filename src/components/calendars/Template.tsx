...
export const Template = () => {
  ...
  return (
    <div>
      <button
        className='flex justify-between items-center px-2 py-1 rounded-lg bg-inherit hover:bg-gray-100 active:bg-gray-200 w-full'
      ...
      >
        ...
        <div className='flex items-center'>
          ...
          />
          {visibleView ? <ChevronDown /> : <ChevronUp />}
        </div>
      </button>
      {visibleView && (
            ...
            return (
              ...
              >
                ...
                <div className='flex gap-2'>
                  ...
                  <ButtonIcon
                    icon={
                      <Pencil className='text-gray-500 group-hover/button:text-black h-5 w-5' />
                    }
                    className='h-6 w-6'
                    onClick={handleCreateTemplate}
                  />
